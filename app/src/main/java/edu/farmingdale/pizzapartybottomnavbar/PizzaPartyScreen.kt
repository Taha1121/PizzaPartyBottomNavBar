...
fun HungerLevelSelection(
    ...
    val hungerItems = listOf("Light", "Medium", "Slight hunger", "Very hungry")
    ...
    RadioGroup(
        ...
        selectedOption = when (hungerLevel) {
            ...
            HungerLevel.LIGHTHUNGER -> hungerItems[2]
            else -> hungerItems[3]
        },
        onSelected = {
            onSelected(when (it) {
                ...
                hungerItems[2] -> HungerLevel.LIGHTHUNGER
                else -> HungerLevel.HUNGRY
            })
        },
        modifier = modifier
    )
